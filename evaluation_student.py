if __name__ == '__main__':
    ...
    #parser.add_argument('--teacher_path', type=str, default='models/train_teacher/{}/{}_0/seed_1/{}/teacher.pt'.format(source_set,source_set,mask), help='checkpoint of the teacher network')
    #parser.add_argument('--student_path', type=str, default='models/train_{}_student_{}/{}/{}_{}/seed_1/{}/student.pt'.format(setting,int(density*100), source_set, target_set, mask,mask), help='checkpoint of the student network')
